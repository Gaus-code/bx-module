<style>
    :root {
        ...
        --color-theme: #F1EEDB;
        --color-bg: rgb(115, 103, 240);

        --animation-sentence: 'Ты знаешь, что должен уйти, да?';
    ...
    * {
    ...
    @keyframes showText {
        ...
        100% {
            --animation-sentence: 'Так много дел, так много дел...';
        }
    }
    @keyframes showNewText {
        ...
        100% {
            --animation-sentence: 'Все, я устал летать. Тут постою';
        }
    }
