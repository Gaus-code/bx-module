...
<div class="modalCard">
	...
	<form action="/reg" method="post" class="modalCard__form">
		...
		<div class="modalField">
			...
			<input class="modalCard__form_input validate" autocomplete="off" type="text" name="firstname" maxlength="30" placeholder="Имя">
		</div>

		<div class="modalField">
			<img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/user.svg" alt="click and write your surname" class="modalField__img">
			<input class="modalCard__form_input validate" autocomplete="off" type="text" name="lastname"  maxlength="30" placeholder="Фамилия">
		</div>

		<div class="modalField">
			<img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/email.svg" alt="click and write your E-mail" class="modalField__img">
			<input class="modalCard__form_input validate" autocomplete="off" type="text" name="email" maxlength="100" placeholder="Почта">
		</div>


		<div class="modalField">
			<img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/user.svg" alt="click and write your surname" class="modalField__img">
			<input class="modalCard__form_input validate" type="text" placeholder="Логин" name="login">
		</div>

		<div class="modalField">
			<img src="<?= SITE_TEMPLATE_PATH ?>/assets/images/key.svg" alt="click and write your Password" class="modalField__img">
			<input class="modalCard__form_input validate password" autocomplete="off" type="password" maxlength="200" name="password" placeholder="Пароль">
